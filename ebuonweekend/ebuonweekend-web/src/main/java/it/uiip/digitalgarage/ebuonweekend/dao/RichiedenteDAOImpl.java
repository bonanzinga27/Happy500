...
public class RichiedenteDAOImpl implements RichiedenteDAO {
    ...
    private static final String UPDATE = "UPDATE richiedente SET nome=?, cognome=?, codFisc=? , dataNascita=?, cittaNascita=? ,provNascita=?, telefono=?, cittaResidenza=?, provResidenza=?, indirizzoResidenza=?, emailRichiedente=?, cartaIdentitaPath=?, codFiscPath=? WHERE id=?";
